package vn.marketplace.inventory.architecture;
...
class FitnessFunctionsTest {
    ...
    private static JavaClasses inventoryClasses;

    @BeforeAll
    static void importClasses() {
        inventoryClasses = new ClassFileImporter()
                .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
                .importPackages("vn.marketplace.inventory");
    }

    @Test
    void dependencyInversion_domainDependsOnNothingOutward() {
        noClasses()
                .that().resideInAPackage("vn.marketplace.inventory.domain..")
                .should().dependOnClassesThat().resideInAnyPackage(
                        "vn.marketplace.inventory.application..",
                        "vn.marketplace.inventory.adapter..",
                        "org.springframework..",
                        "jakarta..",
    ...
    void eventPublish_stateWritingUseCasesAreAnnotated() {
        ...
        methods()
                .that().areDeclaredInClassesThat().resideInAPackage("vn.marketplace.inventory.application..")
