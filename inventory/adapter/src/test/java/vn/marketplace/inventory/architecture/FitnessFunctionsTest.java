...
class FitnessFunctionsTest {
    ...
    private static final FitnessHarness EA = FitnessHarness.forSystem("marketplace-inventory");
    ...
    @Test
    void domain_is_pure() {
        EA.evaluate("domainIsPure", MsfwFitness.domainIsPure("vn.marketplace.inventory"), CLASSES);
    }

    @Test
    void use_case_slices_do_not_cross_depend() {
        EA.evaluate("useCaseSliceIsolation", MsfwFitness.useCaseSlices("vn.marketplace.inventory.application.(*).."), CLASSES);
    }
