...
class FitnessFunctionsTest {
    ...
    void dependencyInversion_domainDependsOnNothingOutward() {
        noClasses()
                .that().resideInAPackage("vn.marketplace.notification.domain..")
                .should().dependOnClassesThat().resideInAnyPackage(
                        "vn.marketplace.notification.application..",
                        "vn.marketplace.notification.adapter..",
                        "org.springframework..",
                        "jakarta..",
    ...
    void eventPublish_stateWritingUseCasesAreAnnotated() {
        ...
        methods()
                .that().areDeclaredInClassesThat().resideInAPackage("vn.marketplace.notification.application..")
