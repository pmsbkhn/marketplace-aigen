...
class FitnessFunctionsTest {
    ...
    void dependencyInversion_domainDependsOnNothingOutward() {
        noClasses()
                .that().resideInAPackage("vn.marketplace.catalog.domain..")
                .should().dependOnClassesThat().resideInAnyPackage(
                        "vn.marketplace.catalog.application..",
                        "vn.marketplace.catalog.adapter..",
                        "org.springframework..",
                        "jakarta..",
    ...
    void eventPublish_stateWritingUseCasesAreAnnotated() {
        ...
        methods()
                .that().areDeclaredInClassesThat().resideInAPackage("vn.marketplace.catalog.application..")
