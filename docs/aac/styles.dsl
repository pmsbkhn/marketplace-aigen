styles {
    ...
    element "Component"        { background #85bbf0; color #000000; shape RoundedBox }
    ...
    element "Ingress"      { stroke #ff8c00; strokeWidth 5 }
    element "InternalApi"  { stroke #2e86de; strokeWidth 5 }
    element "Sensitive"    { stroke #c0392b; strokeWidth 6 }
    element "Standin"      { opacity 55; border dashed }
