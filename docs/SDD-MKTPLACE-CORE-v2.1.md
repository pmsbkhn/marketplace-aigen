...
| --- | --- |
| Mã tài liệu | `SDD-MKTPLACE-CORE-v2.1` |
| Phiên bản | `2.1.0` |
| Trạng thái | ☑ Approved |
| Ngày tạo | 06/06/2026 |
...
> **Ngưỡng tách view:** ~7 BC hiện tại còn đọc tốt với Landscape + 2 Container ví dụ. Khi chạm ~10+ BC hoặc đa P&L → tách Container diagram cho **mọi** BC và chuyển sang **model-as-code** (một model, nhiều view — vd Structurizr DSL) để các tầng không lệch nhau.
